 ...
 */
	...
	/* IAMROOT, 2022.11.05:
	 * - thread_info->flags에서 TIF_SINGLESTEP flag가 1이면 수행.
	 *   mdscr_el1.ss 비트를 clear 하여 DBG_MDSCR_SS 기능 disable.
	 *
	 *   DBG_MDSCR_SS: low-level stepping control flag
	 */
...
9990:
	...
	/* IAMROOT, 2022.11.05:
	 * - thread_info->flags에서 TIF_SINGLESTEP flag가 1이면 수행.
	 *   mdscr_el1.ss 비트를 set 하여 DBG_MDSCR_SS 기능 enable.
	 *
	 *   DBG_MDSCR_SS: low-level stepping control flag
	 */
